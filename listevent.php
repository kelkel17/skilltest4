          ...
          <th>Action</th>
            ...
            <?php  
                 ...
                 
                  {
                        ...
                        echo '<div class="cell">';
                              echo '<td> <a href="updateevent.php?id='.$row['event_id'].' "> <input type="submit" class="btn btn-info btn-sm" value="Update"></a>
                              <a href="deleteevent.php?id='.$row['event_id'].' "> <input type="submit" class="btn btn-info btn-sm" value="Delete"></a>
